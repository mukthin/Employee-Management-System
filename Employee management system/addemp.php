...
<head>
    ...
    <!-- Title Page-->
    <title>Add Employee | HR Panel</title>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">New employee details</h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="number" placeholder="W.ID" name="nid" required="required">
                        </div>
